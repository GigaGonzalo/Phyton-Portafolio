...
def Bienvenida():
    ...
    print("Soy Hola Mundo v4, un programa de saludos personalizados")
    print("Pero hablame de ti, te parece? ")

    datos_usuario = {"nombre" : PeticionNombre() , "edad" : PeticionEdad() ,
                      "pais" : PeticionPais()}

    SaludoPersonalizado(datos_usuario.get("nombre"), datos_usuario.get("edad")
                        , datos_usuario.get("pais"))

#Funcion Primaria
def main():
    print(f"Cuarta variacion del mitico Hola Mundo Personalizado \n")
    print(f"="*90 + "\n      HOLA MUNDO v.4      \n" + "="*90 + "\n")
